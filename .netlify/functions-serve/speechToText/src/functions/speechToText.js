...
// functions/speechToText.js
var speechToText_exports = {};
__export(speechToText_exports, {
  convertSpeechToText: () => convertSpeechToText
});
module.exports = __toCommonJS(speechToText_exports);
...
async function convertSpeechToText() {
  const response = await openai.audio.transcriptions.create({
    model: "whisper-1",
    file: import_fs2.default.createReadStream("audio.mp3"),
    language: "en"
  });
  return response;
}
